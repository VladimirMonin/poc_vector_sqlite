...
def test_hash_in_code_comments(evil_md_content, markdown_parser):
    ...
    python_segments = [s for s in code_segments if s.language == "python" and "# H1" in s.content]
    ...
    assert "H1 Top Level" in python_segments[0].headers or "H2 Second Level" in python_segments[0].headers
