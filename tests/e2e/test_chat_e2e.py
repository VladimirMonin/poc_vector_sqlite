...
class TestChatE2E:
    ...
    def test_chat_with_real_query(self, runner):
        ...
        result = runner.invoke(app, ["chat"], input="Привет\n/quit\n")
...
class TestChatHistoryFlags:
    ...
    def test_no_history_flag_disables_history(self, runner):
        ...
        result = runner.invoke(app, ["chat", "--no-history"], input="/tokens\n/quit\n")
    ...
    def test_history_limit_changes_limit(self, runner):
        ...
        result = runner.invoke(app, ["chat", "--history-limit", "5"], input="/quit\n")
    ...
    def test_compress_at_enables_compression(self, runner):
        ...
        result = runner.invoke(app, ["chat", "--compress-at", "5000"], input="/quit\n")
