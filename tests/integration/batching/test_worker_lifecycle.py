...
class TestWorkerLifecycle:
    ...
    def test_full_batch_lifecycle_success(
        ...
        assert batch_job.google_job_id.startswith("mock-batch-job"), "Должен быть mock job_id"
        ...
        for chunk in all_chunks:
            ...
            assert result is not None, f"Чанк {chunk.id} должен иметь вектор в chunks_vec"
