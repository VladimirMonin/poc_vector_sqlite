...
2. Пишем тесты в пакете `tests/` (pytest)
3. Когда всё работает и протестировано — заканчиваем фазу
4. Пишем один или несколько файлов в `doc/architecture/` по завершённой фазе
5. Следуем стайл-гайду: минимум кода, максимум объяснений и диаграмм
6. Обновляем оглавление в `00_overview.md`
