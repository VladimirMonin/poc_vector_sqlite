---
title: "Chunking: стратегии нарезки документов"
description: "Как разбивать большие документы на чанки для векторизации"
...
```plantuml
@startuml
title Chunking большого документа

rectangle "Документ 9000 символов" as doc
