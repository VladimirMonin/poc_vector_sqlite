---
title: "Векторный поиск в SQLite"
description: "Как sqlite-vec хранит и ищет векторы с косинусным расстоянием"
...
note bottom of vec
  BLOB: 768 × 4 bytes = 3 KB
  Косинусное расстояние
end note

legend right
  Три таблицы для одной сущности:
  - main: данные
  - vec: семантика
  - fts: ключевые слова
endlegend
